...
func showUsefulActivities() {
	showActivities(_gUsefulActivities, "Track a useful activity or return to the main menu:", true)
}
...
func updateProcessing(update *tgbotapi.Update) {
	...
	case BUTTON_CODE_PRINT_MENU:
		showMenu()
	default:
		if usefulActivity, found := findActivity(_gUsefulActivities, choiceCode); found {
